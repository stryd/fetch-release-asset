 ...
 * @param params
 */
exports.fetchRelease = (params) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
exports.fetchAsset = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const { url, token } = params;
    const fileRedirectRes = yield axios_1.default.get(url, {
        headers: {
            Authorization: `token ${token}`,
 ...
 */
exports.fetchAssetFromRelease = (params) => __awaiter(void 0, void 0, void 0, function* () {
    const { token, repo, version, assetName } = params;
    const release = yield exports.fetchRelease(params);
    if (!release) {
